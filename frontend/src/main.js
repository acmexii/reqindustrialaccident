...
pluralCaseList.push( {plural: "accidents/accidents", pascal: "AccidentAccident"} )

pluralCaseList.push( {plural: "assessments/assessments", pascal: "AssessmentAssessment"} )
pluralCaseList.push( {plural: "assessments/sickLeaves", pascal: "AssessmentSickLeave"} )

pluralCaseList.push( {plural: "compensations/compensations", pascal: "CompensationCompensation"} )
